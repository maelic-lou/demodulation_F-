...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "demodulationFM.autotvin.dat"
	set constFileTvOut       "demodulationFM.autotvout.dat"
	set constFileHdlTvIn     "demodulationFM.autohdltvin.dat"
	set constFileHdlTvOut    "demodulationFM.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
