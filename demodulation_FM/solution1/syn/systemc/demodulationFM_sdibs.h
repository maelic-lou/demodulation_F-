...
// ==============================================================
#ifndef __demodulationFM_sdibs__HH__
#define __demodulationFM_sdibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(demodulationFM_sdibs) {
    ...
    SC_CTOR(demodulationFM_sdibs):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
