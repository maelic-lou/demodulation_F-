...
decimation1::decimation1(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_trunc_ln2_fu_90_p4);
    sensitive << ( n_0_reg_51 );
    ...
    sc_trace(mVcdFile, trunc_ln2_fu_90_p4, "trunc_ln2_fu_90_p4");
...
void decimation1::thread_trunc_ln2_fu_90_p4() {
    trunc_ln2_fu_90_p4 = n_0_reg_51.read().range(16, 3);
}
...
void decimation1::thread_zext_ln222_fu_100_p1() {
    zext_ln222_fu_100_p1 = esl_zext<64,14>(trunc_ln2_fu_90_p4.read());
}
