...
// ==============================================================
#ifndef __demodulationFM_codEe_H__
#define __demodulationFM_codEe_H__
...
struct demodulationFM_codEe_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(demodulationFM_codEe_ram) {
...
SC_MODULE(demodulationFM_codEe) {
...
demodulationFM_codEe_ram* meminst;


SC_CTOR(demodulationFM_codEe) {
meminst = new demodulationFM_codEe_ram("demodulationFM_codEe_ram");
