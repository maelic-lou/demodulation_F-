...
// ==============================================================
#ifndef __demodulationFM_urg8j__HH__
#define __demodulationFM_urg8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(demodulationFM_urg8j) {
    ...
    SC_CTOR(demodulationFM_urg8j):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
