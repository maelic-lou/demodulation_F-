...
// ==============================================================
#ifndef __demodulationFM_sdhbi__HH__
#define __demodulationFM_sdhbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(demodulationFM_sdhbi) {
    ...
    ACMP_sdiv_seq<ID, 100, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_sdiv_seq_U;

    SC_CTOR(demodulationFM_sdhbi):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
