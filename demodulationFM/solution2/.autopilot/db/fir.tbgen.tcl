...
set C_modelArgList {
	{ x_V int 32 regular {array 100000 { 1 3 } 1 1 }  }
	{ y_V int 32 regular {array 100000 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ x_V_address0 sc_out sc_lv 17 signal 0 } 
	{ x_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ x_V_q0 sc_in sc_lv 32 signal 0 } 
	{ y_V_address0 sc_out sc_lv 17 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "x_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "x_V", "role": "address0" }} , 
 	...
 	{ "name": "y_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "y_V", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.hwin_V_U", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "9597088", "Max" : "9597088"}
	, {"Name" : "Interval", "Min" : "9597088", "Max" : "9597088"}
]}
...
set Spec2ImplPortList { 
	x_V { ap_memory {  { x_V_address0 mem_address 1 17 }  { x_V_ce0 mem_ce 1 1 }  { x_V_q0 mem_dout 0 32 } } }
	y_V { ap_memory {  { y_V_address0 mem_address 1 17 }  { y_V_ce0 mem_ce 1 1 }  { y_V_we0 mem_we 1 1 }  { y_V_d0 mem_din 1 32 } } }
}
