...
entity demodulationFM_cobkb_rom is 
    generic(
             DWIDTH     : integer := 9; 
             AWIDTH     : integer := 7; 
             MEM_SIZE    : integer := 65
...
architecture rtl of demodulationFM_cobkb_rom is 
...
entity demodulationFM_cobkb is
    generic (
        DataWidth : INTEGER := 9;
...
architecture arch of demodulationFM_cobkb is
    component demodulationFM_cobkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    demodulationFM_cobkb_rom_U :  component demodulationFM_cobkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
