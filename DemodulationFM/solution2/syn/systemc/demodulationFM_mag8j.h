...
// ==============================================================
#ifndef __demodulationFM_mag8j__HH__
#define __demodulationFM_mag8j__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(demodulationFM_mag8j) {
    ...
    SC_CTOR(demodulationFM_mag8j):  simcore_mac_2_U ("simcore_mac_2_U") {
