...
// ==============================================================
#ifndef __demodulationFM_mancg__HH__
#define __demodulationFM_mancg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(demodulationFM_mancg) {
    ...
    SC_CTOR(demodulationFM_mancg):  simcore_mac_6_U ("simcore_mac_6_U") {
