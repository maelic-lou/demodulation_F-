...
// ==============================================================
#ifndef __demodulationFM_maeOg__HH__
#define __demodulationFM_maeOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(demodulationFM_maeOg) {
    ...
    SC_CTOR(demodulationFM_maeOg):  simcore_mac_0_U ("simcore_mac_0_U") {
