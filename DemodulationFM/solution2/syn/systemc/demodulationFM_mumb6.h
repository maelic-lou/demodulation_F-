...
// ==============================================================
#ifndef __demodulationFM_mumb6__HH__
#define __demodulationFM_mumb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(demodulationFM_mumb6) {
    ...
    SC_CTOR(demodulationFM_mumb6):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
