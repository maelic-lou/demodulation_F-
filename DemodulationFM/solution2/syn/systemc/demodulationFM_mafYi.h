...
// ==============================================================
#ifndef __demodulationFM_mafYi__HH__
#define __demodulationFM_mafYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(demodulationFM_mafYi) {
    ...
    SC_CTOR(demodulationFM_mafYi):  simcore_mac_1_U ("simcore_mac_1_U") {
