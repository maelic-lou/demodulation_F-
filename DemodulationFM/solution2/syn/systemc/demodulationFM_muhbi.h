...
// ==============================================================
#ifndef __demodulationFM_muhbi__HH__
#define __demodulationFM_muhbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(demodulationFM_muhbi) {
    ...
    SC_CTOR(demodulationFM_muhbi):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
