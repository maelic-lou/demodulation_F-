...
// ==============================================================
#ifndef __demodulationFM_majbC__HH__
#define __demodulationFM_majbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(demodulationFM_majbC) {
    ...
    SC_CTOR(demodulationFM_majbC):  simcore_mac_3_U ("simcore_mac_3_U") {
