...
// ==============================================================
#ifndef __demodulationFM_maocq__HH__
#define __demodulationFM_maocq__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(demodulationFM_maocq) {
    ...
    SC_CTOR(demodulationFM_maocq):  simcore_mac_7_U ("simcore_mac_7_U") {
