...
$(ObjDir)/demodulation_FM_test.cpp_pre.cpp.tb.o : demodulation_FM_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling demodulation_FM_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/demodulation_FM.cpp_pre.cpp.tb.o : demodulation_FM.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling demodulation_FM.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
