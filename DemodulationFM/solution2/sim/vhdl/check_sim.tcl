...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.demodulationFM.autotvin_y_I_V_V.dat"
         "c.demodulationFM.autotvin_y_Q_V_V.dat"
         "c.demodulationFM.autotvin_y_demod_d_V_V.dat"
         "c.demodulationFM.autotvout_y_demod_d_V_V.dat"
         "c.demodulationFM.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.demodulationFM.autotvout_y_demod_d_V_V.dat"
         "rtl.demodulationFM.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
