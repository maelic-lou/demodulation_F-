...
if {[file isfile demodulationFM.autotvin.dat]} {
	file delete -force demodulationFM.autotvin.dat
}

if {[file isfile demodulationFM.autotvout.dat]} {
	file delete -force demodulationFM.autotvout.dat
}
