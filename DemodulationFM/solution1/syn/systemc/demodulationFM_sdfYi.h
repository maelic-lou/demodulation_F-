...
// ==============================================================
#ifndef __demodulationFM_sdfYi__HH__
#define __demodulationFM_sdfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(demodulationFM_sdfYi) {
    ...
    ACMP_sdiv_seq<ID, 64, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_sdiv_seq_U;

    SC_CTOR(demodulationFM_sdfYi):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
