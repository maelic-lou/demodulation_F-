...
// ==============================================================
#ifndef __demodulationFM_malbW__HH__
#define __demodulationFM_malbW__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(demodulationFM_malbW) {
    ...
    SC_CTOR(demodulationFM_malbW):  simcore_mac_2_U ("simcore_mac_2_U") {
