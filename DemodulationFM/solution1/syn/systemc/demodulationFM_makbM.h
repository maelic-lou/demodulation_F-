...
// ==============================================================
#ifndef __demodulationFM_makbM__HH__
#define __demodulationFM_makbM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(demodulationFM_makbM) {
    ...
    SC_CTOR(demodulationFM_makbM):  simcore_mac_1_U ("simcore_mac_1_U") {
