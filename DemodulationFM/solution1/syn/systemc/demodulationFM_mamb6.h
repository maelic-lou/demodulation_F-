...
// ==============================================================
#ifndef __demodulationFM_mamb6__HH__
#define __demodulationFM_mamb6__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(demodulationFM_mamb6) {
    ...
    SC_CTOR(demodulationFM_mamb6):  simcore_mac_3_U ("simcore_mac_3_U") {
