...
// ==============================================================
#ifndef __demodulationFM_mujbC__HH__
#define __demodulationFM_mujbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(demodulationFM_mujbC) {
    ...
    SC_CTOR(demodulationFM_mujbC):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
