...
// ==============================================================
#ifndef __demodulationFM_mug8j__HH__
#define __demodulationFM_mug8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(demodulationFM_mug8j) {
    ...
    SC_CTOR(demodulationFM_mug8j):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
