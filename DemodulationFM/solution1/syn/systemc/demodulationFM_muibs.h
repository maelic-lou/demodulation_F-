...
// ==============================================================
#ifndef __demodulationFM_muibs__HH__
#define __demodulationFM_muibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(demodulationFM_muibs) {
    ...
    SC_CTOR(demodulationFM_muibs):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
