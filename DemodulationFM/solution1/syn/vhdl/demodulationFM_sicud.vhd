...
entity demodulationFM_sicud_rom is 
    generic(
             DWIDTH     : integer := 9; 
             AWIDTH     : integer := 7; 
             MEM_SIZE    : integer := 65
...
architecture rtl of demodulationFM_sicud_rom is 
...
entity demodulationFM_sicud is
    generic (
        DataWidth : INTEGER := 9;
...
architecture arch of demodulationFM_sicud is
    component demodulationFM_sicud_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    demodulationFM_sicud_rom_U :  component demodulationFM_sicud_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
